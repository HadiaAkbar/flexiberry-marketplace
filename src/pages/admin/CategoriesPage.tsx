    ...
    <div>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-[2px]">Organize your products into categories</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-background">
              <tr>
                <th className="px-4 py-[10px] text-left text-[11px] font-bold text-muted-foreground uppercase tracking-[0.7px]">Category</th>
                <th className="px-4 py-[10px] text-left text-[11px] font-bold text-muted-foreground uppercase tracking-[0.7px]">Products</th>
                <th className="px-4 py-[10px] text-left text-[11px] font-bold text-muted-foreground uppercase tracking-[0.7px]">Created</th>
                <th className="px-4 py-[10px] text-left text-[11px] font-bold text-muted-foreground uppercase tracking-[0.7px]">Status</th>
                <th className="px-4 py-[10px] text-left text-[11px] font-bold text-muted-foreground uppercase tracking-[0.7px]">Actions</th>
              </tr>
            </thead>
            <tbody>
              {categories.map((c) => (
                <tr key={c.name} className="hover:bg-muted/30">
                  ...
                  <td className="px-4 py-3 border-t border-border">
                    <span className={`inline-flex items-center gap-1 px-[9px] py-[3px] rounded-full text-[11px] font-bold ${
                      c.status === "Active" ? "bg-green-100 text-green-600" : "bg-secondary text-muted-foreground"
                    }`}>
