  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <p className="text-xs text-muted-foreground mt-[2px]">Configure installment options for your products</p>
      </div>
        ...
        {plans.map((p) => (
          <div
            ...
            className={`bg-background border-[1.5px] rounded-lg p-4 transition-all cursor-pointer ${
              p.selected ? "border-primary bg-primary/5" : "border-border hover:border-primary hover:bg-primary/5"
            }`}
          >
            ...
            <div className="text-[11px] text-muted-foreground mt-[10px]">{p.detail}</div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-card border border-border rounded-lg p-4 lg:p-[18px] shadow-card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-background rounded-lg p-4 text-center">
            ...
            <div className="text-xs text-muted-foreground mt-1">Monthly Collections</div>
          </div>
          <div className="bg-background rounded-lg p-4 text-center">
            <div className="text-2xl font-extrabold text-foreground font-mono">94.8%</div>
            <div className="text-xs text-muted-foreground mt-1">On-time Payment Rate</div>
          </div>
        </div>
      </div>
    </div>
