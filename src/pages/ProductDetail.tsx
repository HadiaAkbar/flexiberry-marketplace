...
const RECENTLY_VIEWED = [
  {
    id: "rv1", name: "Samsung Galaxy S24 Ultra", brand: "Samsung", price: 449999, originalPrice: 499999,
    rating: 4.7, reviews: 89,
    image: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400&q=80",
  },
  {
    id: "rv2", name: "MacBook Pro M3 14\"", brand: "Apple", price: 649999, originalPrice: null,
    rating: 4.9, reviews: 201,
    image: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&q=80",
  },
  {
    id: "rv3", name: "Sony WH-1000XM5", brand: "Sony", price: 89999, originalPrice: 109999,
    rating: 4.8, reviews: 312,
    image: "https://images.unsplash.com/photo-1545127398-14699f92334b?w=400&q=80",
  },
  {
    id: "rv4", name: "iPad Pro M2 12.9\"", brand: "Apple", price: 379999, originalPrice: null,
    rating: 4.8, reviews: 156,
    image: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400&q=80",
  },
  {
    id: "rv5", name: "Google Pixel 8 Pro", brand: "Google", price: 199999, originalPrice: 229999,
    rating: 4.6, reviews: 78,
    image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400&q=80",
  },
  {
    id: "rv6", name: "Samsung 65\" QLED 4K", brand: "Samsung", price: 329999, originalPrice: 389999,
    rating: 4.5, reviews: 43,
    image: "https://images.unsplash.com/photo-1593359677879-a4bb92f4e12a?w=400&q=80",
  },
];
...
const MOCK_REVIEWS = [
  {
    name: "Ahmed Raza", initials: "AR", rating: 5, date: "March 5, 2026",
    comment: "Absolutely amazing product! Flexiberry delivered it next day and the installment plan was hassle-free. Build quality is exceptional and performance is unreal.",
  },
  {
    name: "Fatima Sheikh", initials: "FS", rating: 5, date: "February 28, 2026",
    comment: "Got it on 12-month installment — totally worth it. Packaging was perfect and support team was very helpful explaining all the features.",
  },
];
...
function MiniCard({
  ...
  originalPrice?: number | null; rating: number; isNew?: boolean;
  theme?: typeof DEFAULT_THEME;
}) {
    ...
    <div className="group relative rounded-xl overflow-hidden bg-white border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl cursor-pointer flex flex-col">
      ...
      <div className="p-3 flex-1 flex flex-col gap-1">
        ...
        <div className="flex items-center gap-1.5 mt-auto pt-1">
          <span className="text-[15px] font-extrabold" style={{ color: theme.primary }}>
    ...
    <div className="min-h-screen bg-white flex flex-col" style={{ fontFamily: "'Nunito Sans', 'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-[1240px] mx-auto px-5 py-2.5 flex items-center gap-2 text-[13px] text-gray-500">
          ...
          <span className="font-semibold truncate max-w-xs" style={{ color: theme.primary }}>
            {product.name}
          </span>
        </div>
      </div>
          ...
          <div className="flex-1 pt-1">
            ...
            <div className="mb-5">
              ...
              <p className="text-[13px] font-semibold mt-1.5 flex items-center gap-1.5" style={{ color: "#16a34a" }}>
                ...
                Available from {getMonthlyInstallment(product.price, 12)}/month — 0% markup installment
              </p>
            </div>
                  ...
                  <div className="flex-1">
                    {[[5, 80], [4, 15], [3, 5]].map(([star, pct]) => (
                      <div key={star} className="flex items-center gap-2.5 mb-2">
                        ...
                        <span className="text-[11px] text-gray-400 w-5">{Math.round(product.reviews * pct / 100)}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {relatedProducts.length > 0 && (
        <section className="py-9 border-t border-gray-100 bg-white">
          <div className="max-w-[1240px] mx-auto px-5">
            <h2 className="text-[22px] font-extrabold text-gray-900 mb-1.5" style={{ fontFamily: "'Nunito', 'Space Grotesk', sans-serif" }}>
              You Might Also Like
            </h2>
      ...
      <section className="py-9 border-t-2 border-gray-100" style={{ background: "#fafafa" }}>
        <div className="max-w-[1240px] mx-auto px-5">
          <div className="flex items-center gap-2.5 mb-1.5">
            ...
            <h2 className="text-[22px] font-extrabold text-gray-900" style={{ fontFamily: "'Nunito', 'Space Grotesk', sans-serif" }}>
              Recently Viewed
            </h2>
          </div>
          <div className="w-14 h-[3px] rounded-full mb-7" style={{ background: theme.primary }} />
